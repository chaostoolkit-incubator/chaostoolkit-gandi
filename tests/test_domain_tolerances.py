...
from chaosgandi.domains.tolerances import domain_nameservers_should_contain, \
    domain_nameservers_should_not_contain, \
    domain_nameservers_should_be_a_subset_of, \
    domain_nameservers_should_be_a_superset_of, \
    domain_nameservers_should_be_exactly, domains_should_not_expire_in
...
def test_domain_nameservers_should_be_exactly():
    assert domain_nameservers_should_be_exactly(
        ["ns1", "ns2"], ["ns2", "ns1"]) is True
